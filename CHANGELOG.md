...
- **Provider heartbeat.** The connection chip and Settings now say *when* each provider last reported, flag one that has gone silent for 10+ minutes, show the last hook error, and warn when the installed hook bridge is older than the app.
