...
- **Sidebar (left)** — the launch nav at the top (a folder switcher over New Claude Code / New Codex / New terminal / Cursor / Chrome, the folder's own commands, New project, Projects folder — drop a folder from Explorer to launch there), then **Limits** and **Open windows**, each collapsing to its header (View → *Sidebar* toggles them).
